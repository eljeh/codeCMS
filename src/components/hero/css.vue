  ...
  methods: {
    ...
    downloadData() {
      const jsonData = JSON.stringify({
        css: {
          heroMobile: this.heroMobile,
          heroDesktop: this.heroDesktop,
      ...
      if (file) {
        ...
        reader.onload = (e) => {
          try {
            ...
            this.heroMobile = uploadedData.css.heroMobile;
            this.heroDesktop = uploadedData.css.heroDesktop;
